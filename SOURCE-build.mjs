...
.signoff{display:flex;align-items:center;gap:16px;margin-top:50px}.signoff .mono{font-size:8px}.signoff p{font-size:10px;color:#5f6d69;margin-top:6px}
...
.motion{display:flex;align-items:center;gap:5px;font-size:8px;color:#5f6d69;margin-top:4px}.motion:hover{color:var(--ink)}
...
.filters{display:flex;align-items:center;justify-content:space-between;gap:20px;border-top:1px solid var(--line);border-bottom:1px solid var(--line);padding:18px 0;margin-bottom:36px}.filters .set{display:flex;gap:28px;flex-wrap:wrap}.filters button{font-size:12px;color:#5f6d69;display:flex;gap:6px;align-items:center}.search input::placeholder{color:#5f6d69}.filters button b{font:8px var(--mono);font-weight:400}.filters button[aria-pressed=true]{color:var(--ink);font-weight:700}.filters button[aria-pressed=true]:before{content:'';width:5px;height:5px;border-radius:50%;background:var(--accent)}
...
writeFileSync(join(OUT,'404.html'),head({title:'Page not found | Gati',description:'This page could not be found.',page:'404'})+`<main class="missing" id="top"><a href="${u('index.html')}">${logoMark(false)}</a><h1>Not every path<br>leads to a project.</h1><p>This page may have moved. Head back to solid ground.</p><a class="btn" href="${u('index.html')}">Back to the homepage ${icons.arrow}</a></main></body></html>`);
