...
.gallery-bar{display:flex;align-items:center;justify-content:space-between;gap:14px;padding-top:17px}.gallery-bar .mono{font-size:7px;color:#8b948c}.gallery-bar p{font-size:10px;margin-top:6px;color:#55645d}
...
.note{display:flex;justify-content:space-between;gap:20px;margin-top:32px;padding-top:20px;border-top:1px solid var(--line)}.note .mono{font-size:8px;color:#8b958e}.note p{font-size:10px;color:var(--muted)}
...
.tabs{display:grid;grid-template-columns:repeat(4,1fr);gap:0;margin-top:64px}.tabs button{text-align:left;color:#aab8ad}.tabs .num{font-size:74px;line-height:1;letter-spacing:-4px;display:block;transition:color .2s}.tabs .lbl{display:block;font:9px var(--mono);letter-spacing:1.5px;margin-top:22px;color:#7d8c80}.tabs .rule{display:block;height:1px;background:#c6d3c6;margin-top:22px;position:relative}.tabs .rule i{position:absolute;left:0;top:-3px;width:7px;height:7px;background:#b5c9b9}
...
.people{border-top:1px solid var(--line);display:grid;grid-template-columns:1.05fr 1fr;gap:82px;align-items:center;padding-top:86px;padding-bottom:104px}.people img{width:100%;height:390px;object-fit:cover;object-position:48% center;filter:saturate(.66)}.people .mono{display:block;font-size:8px;color:#8d978e;margin-top:13px}
...
.credit{font-size:10px;line-height:1.85;color:#8b958c;margin-top:30px;max-width:800px}
...
@media(max-width:680px){.btn{font-size:11px;min-height:48px;padding:13px 16px;gap:14px}.btn.small{font-size:11px;min-height:44px;padding:12px 16px}html{scroll-padding-top:78px}.container{width:calc(100% - 40px)}.utility{height:24px;font-size:6px}.utility .container span:first-child{display:none}.head{height:72px}.head img{width:162px}nav.main,.head .btn{display:none}.burger{display:grid;place-items:center}.mobile{display:flex;flex-direction:column;padding:6px 20px 20px;border-top:1px solid var(--line)}.mobile[hidden]{display:none}.mobile a{display:flex;align-items:center;gap:16px;padding:17px 2px;border-bottom:1px solid var(--line);font-size:17px}.mobile a .mono{font-size:10px;color:#7f9f88}.mobile a svg{margin-left:auto}
...
@media(min-width:861px){:root{--muted:#4a5854;--soft:#b9c8c5}.mono{font-size:12px}.eyebrow{font-size:12px;color:#3f4e48}.utility{font-size:10px}.utility a{font-size:12px}.lead{font-size:18px;max-width:560px}.hero-actions .text-link{font-size:14px}.note .mono{font-size:10px;color:#6b7a75}.note p{font-size:14px}.frame-tag{font-size:10px}.controls .mono{font-size:12px}.gallery-bar .mono{font-size:10px;color:#6b7a75}.gallery-bar p{font-size:14px}.motion{font-size:11px}.partners .label .mono{font-size:12px}.partners .label p{font-size:14px}.caption p{font-size:13px}.caption p span{color:#8a948c}.kind{font-size:9px}.credit{font-size:13px}.head-row .text-link{font-size:14px}.acc summary .mono{font-size:12px}.acc .body p{font-size:15px;color:#c3d1cb;max-width:500px}.acc .body a{font-size:13px}.acc li,.chips span{font-size:11px}.tabs .lbl{font-size:11px;color:#6d7d72}.step p{font-size:15px}.step h3{font-size:27px}.people .mono{font-size:11px;color:#6b7a75}.people p{font-size:15px}.cta p{font-size:14px}.signoff .mono{font-size:11px}.signoff p{font-size:14px}.f-top .brand p{font-size:14px;color:#b4c4be;max-width:320px}.f-links .mono,.f-contact .mono{font-size:11px;color:#9fb1ab}.f-links a{font-size:14px}.f-contact p,.f-contact .mail{font-size:14px}.f-bottom p{font-size:11px;color:#9fb1ab}.f-bottom div{font-size:12px}.filters button{font-size:14px}.search input{font-size:14px}.service .num{font-size:12px}.service .txt p{font-size:15px}.service li{font-size:14px}.service figcaption{font-size:11px;color:#6b7a75}.about-img .mono,.visual .mono{font-size:11px}.story p{font-size:16px}.f-grid .mono{font-size:11px;color:#5f7a6d}.f-grid p{font-size:14px}.other .mono{font-size:11px}.other p{font-size:14px}.role .idx{font-size:12px}.role .meta{font-size:13px}.role p.body{font-size:14px}.role li{font-size:11px}.way span{font-size:13px}.faq details p{font-size:14px}.faq summary{font-size:16px}.contact-grid .lead{font-size:16px;max-width:460px}.aside{font-size:15px}.dark .aside,.split .aside{color:#b4c6c1}.acc summary .mono,.tabs .lbl{color:#8fa39b}nav.main a{font-size:15px;padding:14px 0}nav.main{gap:36px}.utility{height:34px}.utility a{font-size:11px;padding:8px 0}.f-links a{font-size:15px;padding:5px 0;display:inline-block}.f-contact .mail{padding:4px 0;display:inline-block}.f-bottom a{padding:6px 0;display:inline-block}.motion{font-size:11px;padding:6px 0}.acc li{font-size:11px;padding:7px 10px}.filters button b{font-size:11px}.chips span{font-size:11px}.kind{font-size:10px}.counter,.controls i{font-size:12px}.hero-actions .btn{font-size:15px;min-height:60px;padding:18px 30px}.filters button{padding:6px 0}.f-contact a{padding:4px 0;display:inline-block}}
`;
...
<div class="visual"><img class="service-shot" src="${u('assets/images/site-3.webp')}" alt="${services[0].alt}" width="1600" height="900"><span class="mono service-label">THE SCOPE / 01</span><p class="service-line">${services[0].short}</p></div></div></div></section>
...
page({title:'Gati — The work comes first.',description:`RCC structural execution, civil works and hands-on construction across ${P.region}. Talk to the team on WhatsApp, call or email.`,slug:'',body:home});
